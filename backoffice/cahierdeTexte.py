...
def renderAddWindow():
    ...
    def addStudent():
        ...
        if (idCours == "" or idCours == " ") or (Date == "" or Date == " ") or (Description == "" or Description == " "):
    ...
    addCanvas.create_text(49.0, 10.0, anchor="nw", text="Ajouter cahier de texte", fill="#FFFFFF", font=("Inter SemiBold", 24 * -1))
    ...
    addCanvas.create_text(325.0, 85.0, anchor="nw", text="IdCours", fill="#000000", font=("Inter", 11 * -1))
    ...
    addCanvas.create_text(326.0, 147.0, anchor="nw", text="Date", fill="#000000", font=("Inter", 11 * -1))
    ...
    addCanvas.create_text(326.0,211.0,anchor="nw",text="Description",fill="#000000",font=("Inter", 11 * -1))
...
mainCanvas.create_text(73.0,15.0,anchor="nw",text="Gestion des cahiers de texte",fill="#FFFFFF",font=("Inter SemiBold", 36 * -1))
